...
http://github.com/mahsanet/NikaNG/releases/latest

![pic](https://pbs.twimg.com/media/GjLcHCBWEAAoLiM?format=png&name=small)
...
نسخه 1.0.0 بتا نرم افزار بگذر ویندوز پس از سالها روی گیت هاب در دسترس قرار گرفت، این نسخه شدیدا بتا هست فقط میخوام کارتون راه بیوفته. 🙄💖
مخلصیم!

Github :

https://github.com/Begzar/BegzarWindows
...
نرم‌افزار گارد آزادی یک فیلترشکن متن‌باز رایگان برای ویندوز و لینوکس هست، که از کانفیگ‌های وارپ، وایرگارد، Vless، Vmess و ... پشتیبانی می‌کنه.
این‌برنامه در خودش Warp-plus و Hiddify-core رو ادغام کرده و می‌تونین به کمک کانفیگ‌های اهدایی بدون دردسر ازش استفاده کنین.

[Pic](https://pbs.twimg.com/media/Gi13ep9X0AAKUMX?format=jpg&name=small)



## نسخه 2 گارد آزادی منتشر شد.


تغییرات این نسخه شامل بازنویسی برنامه، اضافه کردن چند قابلیت، بهبود رابط کاربری، اضافه کردن چند سرویس جدید و بهبود حالت خودکار میباشد.
...
https://x.com/Freedom_Guard_N/status/1895507446455836908
...
## 🔴فیلترشکن «Bonbast VPN»؛سازنده‌ ناشناس، ردیاب‌های گسترده!
...
## Ceno
 ...
 از مرورگر Ceno چه می‌دانیم؟
۳/۱ 💻سنو یک مرورگر است که با استفاده از فناوری همتا‌به‌همتا (P2P) به کاربران کمک می‌کند تا به محتوای فیلترشده دسترسی داشته باشند. این مرورگر از شبکه BitTorrent برای ذخیره و توزیع صفحات وب استفاده می‌کند.

https://x.com/filterbaan/status/1884956502542151857

۳/۲ 🛑دو حالت مرور در #سنو : ✅ حالت عمومی: محتوا در بین کاربران توزیع می‌شود، دسترسی به سایت‌های فیلترشده راحت‌تر است. ✅ حالت شخصی: داده‌ها رمزنگاری شده و ذخیره نمی‌شوند، #امنیت و حریم خصوصی بیشتر است.

 🔐 آیا Ceno قابل ردیابی است؟خیر! داده‌های شما #رمزنگاری می‌شود و هیچ واسطه‌ای امکان خواندن اطلاعات را ندارد.
 سنو چگونه #سانسور را دور می‌زند؟ با ذخیره کردن نسخه‌های وب در بین کاربران، حتی اگر سایتی مسدود باشد، نسخه‌های آن همچنان قابل دسترسی خواهند بود.

 ## WG Tunnel

اپ WG Tunnel، یک کلاینت متن‌باز جایگزین برای وایرگارد در اندروید هست، که ازش می‌تونین برای دورزدن  
فیلترینگ استفاده کنین ...


![pic](https://pbs.twimg.com/media/GitxzHYW0AEb7xg?format=png&name=small)

https://github.com/zaneschepke/wgtunnel/releases/tag/3.6.6
...
https://paskoocheh.com/blog/posts/2023-10-05-halo-vpn-overview.html


https://x.com/PasKoocheh/status/1896541036190552149

![pic](https://pbs.twimg.com/media/GlHeBQ5XoAAGJGP?format=jpg&name=small)