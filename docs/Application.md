...
اپ #mahsaNG (https://twitter.com/hashtag/mahsaNG) در فاصله کوتاهی از انتشار نسخه ۹، مجددا یک بروزرسانی جدید داشته که ضمن بهبود قابل توجه اتصال از طریق Warp و WarpOnWarp، تغییر userAgent، بهبود FakeHost و کانفیگ‌های non-TLS، مشکل پینگ در تعداد بالای کانفیگ و اشکال رابط کاربری در ساخت کانفیگ وارپ و ادیت splitHttp رو برطرف کرده.
