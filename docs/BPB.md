...
عیدی شما آماده شده و عضو جدیدی از خانواده BPB رو معرفی میکنم: 
💦 BPB Wizard

این محصول برای کساییه که اطلاعات فنی کافی ندارن و دنبال کردن آموزش‌های راه اندازی پنل BPB براشون سخته.
یه توضیح کوتاه بدم برای کسایی که بار اوله اینو میبینن، با ساختن پنل BPB میتونید به رایگان و نامحدود کانفیگ‌های v2ray و Wireguard برای خودتون و اطرافیان بسازید.

اما BPB Wizard چیکار میکنه:
ساده بگم یه اکانت رایگان کلادفلر میسازید و روی ویندوز برنامه رو اجرا میکنید، ۶ بار دکمه Enter رو فشار میدید و پنل رو براتون میسازه و توی مرورگر باز میکنه.
اما اگر خواستید میتونید اون ۶ تا سوال رو جواب بدید و شخصی‌سازی کنید.
میتونید نسخه سازگار با سیستم‌عامل خودتون رو از لینک زیر دریافت کنید:

https://github.com/bia-pain-bache/BPB-Wizard/releases/tag/v1.0


![pic](https://pbs.twimg.com/media/Gm1IrjxX0AAvIRE?format=jpg&name=small)


 فیلترشکن رایگان شخصی زیر 1 دقیقه با کمک BPB Wizard 🔥

🔸امیدواریم این ویدیو بتونه بهتون برای استفاده از اینترنت آزاد کمک کنه. با تشکر زیاد از @bia_pain_bache
 ❤️

🔗 تماشا ویدیو در یوتیوب 👇👇
 https://youtu.be/r0ct3Xq6-Jg


 <iframe width="560" height="315" src="https://www.youtube.com/embed/r0ct3Xq6-Jg?si=vlZfuIrmXV0p_2fD" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
۶- در قسمت Warp general یه دانلود اضافه شده که کانفیگ‌های وارپ رو به تعداد endpoint هایی که وارد کرده باشید در یک فایل zip بهتون میده. میتونید از این فایل‌های کانفیگ در برنامه‌هایی مثل WG Tunnel و کلاینت وایرگارد استفاده کنید.
...
[نسخه ۲.۳ پنل BPB ریلیز شد!](https://threadreaderapp.com/thread/1777729570692628977.html)
