...
کلودفلیر تبدیل سرویس های ورکر را به پراکسی غیر مجاز اعلام کرده است و خطای ۱۱۰۱ اعلام می کند و گروهی بر این باور هستند که با این حال باید برای دسترسی عموم ایرانیان به اینترنت آزاد تلاش باید کرد.
