...
##  نصب VPN بروک در سرور میکروتیک BROOK VPN 

بروک یک ارتباط امن و بدون دردسر با کلاینهای بسیار خوبی که داره اتصال مداوم شما رو به اینترنت آزاد تضمین میکنه  هم برای ایرانسل و همراه اول و سایر اپراتور ها عالی جواب میده از طرفی  نیاز به تهیه سرور مجزا هم ندارید تو اوبونتو کنار پنل خودتون میتونید بصورت همزمان داشته باشیدش
امروز با هم داخل میکروتیک تحت کانتینر نصب و کانفیگش میکنیم
تمام دستورات در کانال تلگرام هست


https://www.youtube.com/watch?v=V2RMFT7-NVs
