...
##  آموزش اتصال به روش فالکون در وی پی ان آرگو - Argo VPN Falcon Network 
...
نیازمندی ها : 
1. دامین
ویدیو ثبت دامنه :    • آموزش ثبت دامنه وب سایت com و ir - طر...  
2. ثبت نام در سایت کلادفلر
https://cloudflare.com

مراحل کار :
1. ثبت نام در سایت CloudFlare با یک ایمیل معتبر
2. تایید حساب کاربری با کلیک بر روی ایمیل دریافتی از سایت کلادفلر
3. اضافه و متصل کردن دامین به کلادفلر و انتخاب پلن و سرویس رایگان
4. ست کردن DNS های کلادفر بر روی DNS های دامنه خریداری شده 
تنظیم DNS ها ممکن است تا 24 ساعت زمان بر باشد
5. ست کردن یک A رکورد در بخش DNS های هاست کلادفلر براساس IP دریافتی از اپ
از منوی اصلی ArgoVPN وارد بخش «فالکن» (Falcon) شوید و IP نمایش داده شده در بالای صفحه را یادداشت کنید. اکنون در کلودفلر یک رکورد A ایجاد کنید و آنرا به IPی که در مرحله قبل دریافت کردید پوینت کنید. گزینه "Proxy status" نیز باید روی "Proxied" تنظیم شود (آیکن نارنجی رنگ نمایش داده شده باشد).
6. تنظیمات بخش SSL/TLS کلادفلر و قراردادن بر روی FULL
قبل از اینکه تنظیمات کلودفلر را ذخیره کنید، دقت کنید SSL را درحالت FULL قرار دهید. 
مرحله 7 (پایانی) : تنظیم دامنه در اپ
پس از ذخیره تنظیمات کلودفلر وارد برنامه شوید و در قسمت «تنظیمات فالکن» (Falcon Settings) آدرس رکوردی که در کلودفلر ساخته اید را در محل مربوط بدون هرگونه http:// یا https:// وارد کنید و بر روی دکمه «ذخیره» (Save) کلیک کنید
حال به صفحه اصلی برنامه برگردید و گزینه «نوع اتصال» (Connection Type) را بر روی «شبکه فالکن» (ArgoVPN Falcon Network) قرار داده و اقدام به اتصال کنید.

درباره شبکه فالکن: اگر با استفاده از شبکه عمومی و یا پُل قادر به برقراری ارتباط نبودید، میتوانید از «شبکه فالکن» استفاده کنید. شبکه فالکن این امکان را به شما میدهد تا با استفاده از دامین شخصی خودتان به ArgoVPN متصل شوید. توجه داشته باشید که ما به کاربران خود توصیه می‌کنیم از دامنه‌های اصلی خود برای اتصال به ArgoVPN استفاده نکنند و آنها را بصورت عمومی در شبکه های اجتماعی منتشر نکنند، چراکه این عمل منجر به بلاک شدن دامین شما میشود. برای استفاده از شبکه فالکن ابتدا یک اکانت کلودفلر ایجاد کنید و دامین خود را به آن متصل کنید. توجه داشته باشید دامین شما می‌تواند هرچیزی باشد حتی یک دامین دات آی‌آر


0:00 مقدمه
0:30 نیازمندی ها
1:15 از چه سایت هایی دامنه خرید کنم؟
3:40 ثبت نام در کلادفلر
4:58 تایید حساب کاربری کلادفلر
5:24 اضافه کردن و متصل کردن دامین
6:42 ست کردن دی ان اس ها بر روی دامین
10:46 ایجاد رکورد
12:03 تنظیم SSL
12:28  منتظر ست شدن تنظیمات در کلادفلر  
13:27 تنظیم دامین در اپ


<iframe width="560" height="315" src="https://www.youtube.com/embed/CXyqweHOcu4?si=K_nob-hhPKkCEyUD" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
