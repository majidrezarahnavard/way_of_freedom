...
سلام سلام میکروتیکی‌های عزیز!

پروژه «نس-نت کانکت» داره با سرعت و هیجان پیش میره و حالا وارد مرحله تست شدیم. 🚀

خیلی زود زمان انتشار اولین نسخه رو اعلام می‌کنیم 🤩

🔴 از جمله امکانات اصلی نسخه اول شامل:

✔️ تنظیمات وایرلس

✔️ امکان آپلود کانفیگ وایرگارد برای مخفی کردن آی‌پی استارلینک 

✔️ تفکیک ترافیک ایران و بین‌المللی

✔️ تنظیمات پایه‌ای امنیتی میکروتیک

✔️اتصال به استارلینک از راه دور (آی‌پی پابلیک و اینترنت داخلی نیاز است)

⚙️ این پروژه با هدف ساده‌تر کردن کار شما طراحی شده که حتی بدون داشتن هیچ‌گونه دانش فنی بتونید میکروتیک‌تون رو خودتون کانفیگ کنید.
