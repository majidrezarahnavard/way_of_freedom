#  سایت جامع فیلترشکن ( VPN )

##   روش‌های اتصال به اینترنت آزاد

این دانشنامه به منظور دسترسی به اینترنت آزاد در فیلترینگ و نظارت شدید حکومتی و پروایدر های اینترنت مهیا شده است. این دانشنامه حاصل تلاش هزاران نفر به طور شناس و ناشناس به صورت غیر متمرکز در زمینه رفع فیلترینگ می باشد. روش ها و دسته بندی های بسیار متنوع و گوناگون معرفی شده است، با توجه به نیاز خود از آنها بهره ببرید.

## ⛔اینترنت آزاد یا برای همه یا هیچکس⛔

فیلترشکن یا در اصطلاح عموم VPN ابزاری برای دستیابی به اینترنت آزاد می باشد. رویای سگارو دسترسی اینترنت آزاد بدون هزینه برای ایرانیان بود.
این مستندات حاوی تمام روش های رایگان، با سرور و تانل و تحقیقات در مورد اینترنت و فیلترینگ می باشد.
...
در حالی  که فیلترینگ تمرکز بر فیلترینگ سایت های انحرافی دارد، ولی پیروان حکومت و عالی ترین مقام های دولتی از پلتفرم های فیلترشده مانند  توییتر و اینستاگرام استفاده می کنند. و بر استفاده از اینترنت طبقاتی که برگرفته از اندیشه کمونیست هست صحبت می کنند.


## دسته بندی ها

این دانشنامه مطالب را به صورت غیرمتمرکز از سراسر اینترنت جمع آوری می کند. هدف شکستن فیلترینگ و سانسور شدید اطلاعات در ایران می باشد. برخی از این موارد عبارتند از خدمات VPN، پیکربندی های زنجیره پروکسی، تنظیمات DNS، راه حل های مبتنی بر سرور و فناوری های نوظهور مانند Warp و Worker. علاوه بر این، برنامه های مشتری، ملاحظات امنیتی و استفاده از ابزارهای خاص مانند Brook، Cloak و Bepass را مورد بحث قرار می دهد. هدف این روش‌ها و ابزارها ارائه گزینه‌هایی به افراد برای دور زدن محدودیت‌های اینترنت و دسترسی به وب باز است.
